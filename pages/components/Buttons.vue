      ...
      <v-card-text class="pt-0">
        <v-row>
          ...
          <v-col cols="12" md="6">
            ...
            <v-btn class="ma-1" color="secondary" rounded>
              Rounded
            </v-btn>
            ...
            <v-btn class="ma-1" color="secondary" fab small>
              <v-icon>
                mdi-heart
              </v-icon>
            </v-btn>
            ...
            <v-col :key="i" cols="12" class="py-1">
              ...
              <v-row dense>
                ...
                <v-col cols="auto" md="1" sm="1">
                  <v-btn :color="s.color" dark min-width="0" max-width="41">
                    <v-icon v-text="s.icon" />
                  </v-btn>
                </v-col>

                <v-col cols="auto" md="1" sm="1">
                  <v-btn :color="s.color" dark fab min-width="0" small>
                    <v-icon v-text="s.icon" />
                  </v-btn>
                </v-col>
